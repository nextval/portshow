...
<form method="post" action="<%=vURL%>/cafeBook.do">
	<input type="hidden" name="category" value="cafeWrite">
	
<table class="box" border="1">
<tr>
<td class="mainList">작성자</td>
<td class="list1">
<input type="text" class="writer" name="list_name" style="height:30px; width:200px;" autofocus
value="<%=vId%>"></td>

					
<td class="mainList">비밀번호</td>
<td class="list2">
<input type="text" class="pwd" name="list_pwd" style="height:30px; width:200px;"></td>
</tr>

<tr>
<td class="mainList">제목</td>
<td colspan="3" class="list3">
<input type="text" class="title" name="list_title" style="height:30px; width:670px;"></td>
</tr>
